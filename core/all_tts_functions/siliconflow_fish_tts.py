...
if __name__ == '__main__':
    ...
    siliconflow_fish_tts("使用动态音色测试", "dynamic_test.wav", mode="preset", ref_audio="output/audio/refers/1.wav", ref_text="Okay folks, welcome back. This is price action model number four, position trading.")